...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="plugins">
        ...
        <html>
            ...
            <body>
                <h2>InaSAFE Autobuilds</h2>
		<p>Note that currently this repo will not update the version number
		   of InaSAFE - to get newer versions, first remove your installed
                   version then re-install.<p>
                <table>
                    <tr>
